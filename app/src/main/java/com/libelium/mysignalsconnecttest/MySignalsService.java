...
/**
 * Created by cazza223 on 10/2/2017.
 */

public class MySignalsService extends IntentService implements BluetoothManagerHelperCallback, BluetoothManagerServicesCallback, BluetoothManagerCharacteristicsCallback, BluetoothManagerQueueCallback{
...
//        System.out.println("hello");
    ...
    private void createInterface() {
        ...
        if (BluetoothManagerHelper.hasBluetooth(c)) {
    ...
    private void scanBluetoothDevices() {
        ...
        bluetoothManager.setInitParameters(this, c);
    ...
    private void performConnection() {
        ...
        if (mService.connectToDevice(selectedDevice, c)) {
        ...
        if (service.getUuid().toString().toUpperCase().equals(StringConstants.kServiceMainUUID)) {
            ...
            if (!writtenService) {
                ...
                if (characteristicSensorList != null) {
                    ...
                    bitManager.objectByte = BitManager.createByteObjectFromSensors(selectedSensors, BLUETOOTH_DISPLAY_MODE.BLUETOOTH_DISPLAY_MODE_GENERAL, c);
