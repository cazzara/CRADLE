...
public class MainActivity extends Activity implements BluetoothManagerHelperCallback, BluetoothManagerServicesCallback, BluetoothManagerCharacteristicsCallback, BluetoothManagerQueueCallback {

	private static String kMySignalsId = "mysignals 000008"; // MySignals advertising name
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			mService.setServicesCallback(MainActivity.this);
			mService.setCharacteristicsCallback(MainActivity.this);
			mService.setQueueCallback(MainActivity.this);
	...
	private void performConnection() {
		...
		if (mService.connectToDevice(selectedDevice, MainActivity.this)) {
	 ...
	 * @param characteristic Notified characteristic
	 */
	private HashMap<String, HashMap> readCharacteristic(BluetoothGattCharacteristic characteristic) {
